...
//FIXME: mi sa che qui il lazy rompe
	public boolean updateRepetitionById(int r_id,int nR, String qR,Date st, Date et,int user_id
			) {
		Session session = sessionFactory.openSession();
	...
	public int insertNewRepetition(int o2,int nR, String type, int user_id, Date st, Date et) {
		Session session = sessionFactory.openSession();
		int result =-1;
