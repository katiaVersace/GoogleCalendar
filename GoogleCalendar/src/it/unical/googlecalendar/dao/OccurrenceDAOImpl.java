...
public class OccurrenceDAOImpl implements OccurrenceDAO {
	...
	@Override
	public int insertNewEvent(Calendar c, User u, String title, String description,Date startTime,Date endTime,String c1, String c2, int a) {
		Session session = sessionFactory.openSession();
		Occurrence ev = new Occurrence(c, u, title, description,startTime,endTime, c1, c2,a);
		int result =-1;
		Transaction tx = null;
...
//	}
	...
	@Override
	public boolean updateEventById(Occurrence v, String title,  String description, Date startTime,Date endTime,String c1, String c2,int user_id,int alarm) {
		Session session = sessionFactory.openSession();
