...
public class IndexController {
	...
	// FIXME: nel path che verrï¿½ chiamato lato client togliere user_id perchï¿½ adesso
	 ...
	 * insertNewEvent
	 */
	// se ritorna -1 significa che l'inserimento non ï¿½ andato a buon fine (manca la
