						...
						<form action="">
							<fieldset>
								<c:forEach items="${calendars}" var="cal">
									<li><label id="cal_entry_${cal.id}"> <input
											type="checkbox" id="${cal.id}" name="${cal.id}"
											value="${cal.title}"
											ng-model="vm.checkedCalendars['${cal.id}']"
											ng-change="vm.toggleCalendar('${cal.id}')" /> <label
											for="${cal.id}"><span></span> ${cal.title}</label>
									</label> <label><i class="glyphicon glyphicon-cog"
											onclick="manageCalendar('${cal.title}','${cal.id}')"
											style="margin-left: 80%;"></i></label></li>
								</c:forEach>
							</fieldset>
						</form>
					</ul></li>
								...
								<div class="col-md-6 text-center">
									<div class="btn-group">
										...
										<button id="btn-add" class="btn btn-primary pull-right"
											ng-click="vm.openEventModal()" style="margin-left: 10px;"
											disabled="disabled">
										...
										<button class="btn btn-primary pull-right"
											style="margin-left: 30px;" ng-click="vm.openMemoModal()">
											<i style="font-size: 16px; color: white;"
				...
				<div class="modal-content">
					...
					<div style="text-align: center;">
						<button type="button" id="newCalendar"
							class="btn btn-info navbar-btn" onclick="addCalendar()"
				...
				<div class="modal-content">
					...
					<div style="text-align: center;">
						<button type="button" id="newCalendar1"
							class="btn btn-info navbar-btn" onclick="updateInfo()"
							style="background: #42A5F5;">
	...
	<div id="modal-wrapper4" class="modal">
		<div>
			<form class="modal-content animate" action="/action_page.php">
				...
				<div class="modal-content">
					<input type="text" placeholder="Change Name" name="uname"
						id="newNameCalndar">
					...
					<div style="text-align: center;">
						<button type="button" id="btn-dlCalendar"
							...
							ng-click="vm.deleteCalendar()" style="background: #C62828;">
				...
				<div class="modal-content" style="width: 90%;">
					...
					<div>
							...
							<form id="form-btn"
								...
								<c:forEach items="${calendars}" var="cal">
									<li style="list-style-type: none;"><input type="radio"
										id="${cal.id}+1" name="rr" value="${cal.id}"
										ng-model="vm.checkedCalendars['${cal.id}']"
										ng-change="vm.toggleCalendar('${cal.id}')" /> <label
						...
						<div style="text-align: center;">
							...
							<button type="button" id="addEvnt" ng-click="vm.addEvent()"
				...
				<div class="modal-content" style="width: 90%;">
					...
					<div>
						...
						<div style="text-align: center;">
							...
							<button type="button" id="upEvent" ng-click="vm.updateEvents()"
								class="btn btn-info navbar-btn" style="background: #42A5F5">
			...
			<form class="modal-content animate" action="/action_page.php">
				...
				<div class="modal-content">
					<div style="text-align: center;">
						...
						<button type="button" id="newCalendar"
							class="btn btn-info navbar-btn" ng-click="vm.addMemo()"
							style="background: #42A5F5">
							<span><strong>Add</strong></span>
						</button>
					</div>
			...
			<form class="modal-content animate" action="/action_page.php">
				...
				<div class="modal-content">
					...
					<div style="text-align: center;">
						...
						<button type="button" id="newCalendar"
							class="btn btn-info navbar-btn" ng-click="vm.updateMemo()"
							style="background: #42A5F5">
							<span><strong>Add</strong></span>
						</button>
					</div>
