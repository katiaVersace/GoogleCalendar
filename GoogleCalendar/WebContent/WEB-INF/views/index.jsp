...
<body data-ng-controller="KitchenSinkCtrl as vm">
                ...
                <c:forEach items="${calendars}" var="cal">
                  <li>
                    <input 
                      ...
                      ng-change="vm.toggleCalendar('${cal.id}')"/>${cal.title}<br />
                    <!-- <a 
                      href="#"
                      title="${cal.title}"
                      ng-model="vm.checkedCalendars['${cal.id}']"
                ...
                <form action="logout">
                  <div class="navbar-header">
                    <button type="submit" id="logout-btn"
                      ...
                      style="background: #337ab7; margin-left: 20px;">
  ...
  <div id="modal-wrapper" class="modal">
    <form class="modal-content animate" action="/action_page.php">
      <div class="imgcontainer">
        ...
        <a href="#" class="avatar"><i style="font-size: 45px; color: white;"
          class="glyphicon glyphicon-calendar"></i></a>
      </div>

      <div class="container">
        <input type="text" placeholder="Name" name="uname"
          style="margin: 8px 26px;"> <input type="text"
          placeholder="Color" name="psw" style="margin: 8px 26px;">
        <textarea rows="4" cols="100" placeholder="Description"></textarea>
        <div>
          <button type="button" id="newCalendar" class="btn btn-info navbar-btn"
            style="background: #42A5F5; margin-left: 535px;">
  ...
  <div id="modal-wrapper1" class="modal">
    <form class="modal-content animate" action="/action_page.php">
      ...
      <div class="container">
        <input type="text" placeholder="Name" name="uname"
          style="margin: 8px 26px;"> <input type="password"
          placeholder="Old Password" name="uname" style="margin: 8px 26px;">
        <input type="password" placeholder="New Password" name="psw"
          style="margin: 8px 26px;">
        <div>
          <button type="button" id="newCalendar" class="btn btn-info navbar-btn"
            style="background: #42A5F5; margin-left: 575px;">
  ...
  <div id="modal-wrapper2" class="modal">
    <form class="modal-content animate" action="/action_page.php">
      ...
      <p style="color: white; text-align: center;">Mario Carricato - 187799
      </p>
